...
OCVOutput3DWrapper::OCVOutput3DWrapper(int width, int height)
{
	this->width = width;
	this->height = height;
...
OCVOutput3DWrapper::~OCVOutput3DWrapper()
{
}


void OCVOutput3DWrapper::publishKeyframe(Frame* f)
{
...
void OCVOutput3DWrapper::publishTrackedFrame(Frame* kf)
{
	lsd_slam_viewer::keyframeMsg fMsg;
  LOGI();
...
void OCVOutput3DWrapper::publishKeyframeGraph(KeyFrameGraph* graph)
{
...
void OCVOutput3DWrapper::publishTrajectory(std::vector<Eigen::Matrix<float, 3, 1>> trajectory, std::string identifier)
{
	// unimplemented ... do i need it?
}

void OCVOutput3DWrapper::publishTrajectoryIncrement(Eigen::Matrix<float, 3, 1> pt, std::string identifier)
{
	// unimplemented ... do i need it?
}

void OCVOutput3DWrapper::publishDebugInfo(Eigen::Matrix<float, 20, 1> data)
{
  LOGI();
